function Player() {
	...
	this.acceleration = new THREE.Vector3(0, -15, 0);
	this.ambientFriction = new THREE.Vector3(-1, 0, -1);
...
Player.prototype.update = (function() {
	...
	return function(delta) {
		...
		//nconsole.log("player volcity " + this.velocity.x+" "+this.velocity.z);
		// Move
